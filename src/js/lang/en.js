...
app.lang['en'] = (function() {
	...
	return {
		...
		'configure.locale.notes': 'Missing your language or see a wrong translation? Please visit <a href="{{projectTranslationsUrl}}">the app\'s project page</a> to learn how to submit new or corrected translations.',

		'debug.title': 'Debug Info',
		'debug.description': 'Found a bug or have some questions? Please <a href="{{projectIssuesUrl}}">open an issue</a> in the app\'s issue tracker.',
		'debug.app': 'App',
